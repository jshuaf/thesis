...
data = {
    "messages": [
        ...
        {"role": "user", "content": "What's the second largest?"},
    ],
    "temperature": 0.8,
    "max_tokens": 128,
}
...
url = "https://Llama-2-7b-chat-thesis-1-serverless.eastus2.inference.ai.azure.com/v1/chat/completions"
# Replace this with the primary/secondary key or AMLToken for the endpoint
api_key = "WfORn289HoK8TFevp1B17CjkizKYdhi0"
if not api_key:
